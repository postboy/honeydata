...
extern int main(void)
{
	...
	const ITYPE orig_array[] =
		{-32710, -32710, -32710, -32712, -32712, -32710, -32710, -32710, -32712, -32712};
	...
	if ((rv = encode_int16_arbitrary(orig_array, &encoded_array, size, min, max, weights)) != 2) {
		error("unexpected output type");
		printf("%d\n", rv);
		test_error();
		}
	decode_int16_arbitrary(encoded_array, decoded_array, size, min, max, weights);
	...
	if ((rv = encode_int16_arbitrary(orig_array, &encoded_array, size, min, max, weights)) != 4) {
		error("unexpected output type");
		printf("%d\n", rv);
		test_error();
		}
	...
	if ((rv = encode_int16_arbitrary(orig_array, &encoded_array, size, min, max, weights)) != 8) {
		error("unexpected output type");
		printf("%d\n", rv);
		test_error();
		}
	...
	if ((rv = encode_int16_arbitrary(orig_array, &encoded_array, size, min, max, weights)) != -1) {
		error("unexpected output type");
		printf("%d\n", rv);
		test_error();
		}
